...
<ul class="languagepicker roundborders large" dir="ltr">
    ...
    <li <?php echo($lang == 'en' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=en<?= $lang_uri ?>"><span class="flag-icon flag-icon-gb"></span>&nbsp EN</a>
    </li>
    <li <?php echo($lang == 'ar' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=ar<?= $lang_uri ?>"><span class="flag-icon flag-icon-ae"></span>&nbsp AR</a>
    </li>
    <li <?php echo($lang == 'cn' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=cn<?= $lang_uri ?>"><span class="flag-icon flag-icon-cn"></span>&nbsp CN</a>
    </li>
    <li <?php echo($lang == 'es' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=es<?= $lang_uri ?>"><span class="flag-icon flag-icon-es"></span>&nbsp ES</a>
    </li>
    <li <?php echo($lang == 'id' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=id<?= $lang_uri ?>"><span class="flag-icon flag-icon-id"></span>&nbsp ID</a>
    </li>
    <li <?php echo($lang == 'jp' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=jp<?= $lang_uri ?>"><span class="flag-icon flag-icon-jp"></span>&nbsp JP</a>
    </li>
    <li <?php echo($lang == 'ko' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=ko<?= $lang_uri ?>"><span class="flag-icon flag-icon-kr"></span>&nbsp KO</a>
    </li>
    <li <?php echo($lang == 'ms' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=ms<?= $lang_uri ?>"><span class="flag-icon flag-icon-my"></span>&nbsp MS</a>
    </li>
    <li <?php echo($lang == 'ru' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=ru<?= $lang_uri ?>"><span class="flag-icon flag-icon-ru"></span>&nbsp RU</a>
    </li>
    <li <?php echo($lang == 'th' ? 'style="display:none;"' : ''); ?>><a
                href="<?= $uri[0] ?>?lang=th<?= $lang_uri ?>"><span class="flag-icon flag-icon-th"></span>&nbsp TH</a>
    </li>
    <li <?php echo($lang == 'vi' ? 'style="display:none;"' : ''); ?>><a
