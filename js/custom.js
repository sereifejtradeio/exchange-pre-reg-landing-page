$(document).ready(function() {
    ...
    // News notification slider
    let newsNotificationCookie = $.cookie("news-notification");

    if( !newsNotificationCookie ) {
        $('#news-notification-container').slideToggle('slow', "linear");
        $('.logonav').css({"top":"225px"});
        $('#headline').css({"top":"225px"});

        $('#news-notification-close-button').click(function () {
            $.cookie("news-notification", 1);
            $('.logonav').css({"top":"0px"});
